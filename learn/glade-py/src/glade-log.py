...
def phase_1(alpha_in):
    ...
    while done == False:
        next_step = False
        started = False
        #print("Before: " + str(curr_reg))
        print("\nNew Step")
        #print("After: " + str(curr_reg))
        ...
        for regex in get_candidates(curr_reg):
            ...
            if all_true: # get the first regex that covers all samples.
                ...
                #print("Adding regex " + var + " to dict ")
...
def change_nonterminal(a, b, cfg):
    ...
    print("\nKeys: " + a + ", " + b)
    print("Grammar before: " + str(cfg))

    new_g = copy.deepcopy(cfg)
   
    new_g[a][0][1] = new_g[b][0][1]
    #new_g[a][1].append(terminal)

    print("\nGrammar after: " + str(new_g))
    return new_g
